...
"product"=>['[[[_SUJ§_ID:link]§txtcadr:css]
...
"rss"=>['[_EDIT:§[imgr:class][text-align:right;:style]:div] [_AVATAR:§[imgl:class][width:60px; padding:0;:style]:div] [_MSG§[panel justy:class][_BKG:style]:div]'],
"book"=>['[[_BACK[_TITLE§h1:balise][_OPT _DATE _TAG _USERTAGS _LENGHT §txtnoir:css]§[text-align:center; color:#ddd; :style]:div][[_MSG§[color:#ddd; font-size:14px; text-align:left;:style]:div]§[background-color:#222; border:1px solid #fff; padding:20px 0 20px 20px; margin:10px; color:white; font-size:24px; :style]:div]§[background-color:black; padding:20px;:style]:div]'],
"lexic"=>['[_0§h3:balise]_1
[:br][:hr][:br]'],
"titles"=>['[[_URL§_SUJ:url]§h3:balise]_PARENT'],
"slideshow"=>['[_7:text]
