...
$r=["_menus_"=>['description'],"philum_pub_txt"=>['[http://philum.fr/2§[phi1§32::picto]:popart] [v[:ver]§txtsmall2:css] [http://philum.fr§[philum:picto]]'],"update_ok_alert"=>['mettre à jour le htaccess /ajax.php et le server param 5 (141201)'],"conn_help_txt"=>['General Principle
...
Translated with www.DeepL.com/Translator (free version)'],"shop_class"=>['this section is obsolete
...
use restriction 55 \'user template\' to activate the procedure of searching user template, then public template, then the one bydefault. (not needed for the template of articles)'],"track_follow"=>['the mail let you to receive other comments'],"track_captcha"=>['copy code here'],"update_ok"=>['The software is up-to-date'],"update_help"=>['If an error occurs, renove all from install.php'],"upload_folder"=>['select a directory xhere send documents ;
...
- precise date (API): \"date:1967,\" or \"date:-08-15\" (every 15 August)'],"defcons"=>['The Definitions are using some input and outputs for title, text, and another option if needed. Il the output is not set, it will be the natural end of the balise. Lot of rules let adjust the content, as del the title, the line 1, a link or a line with a keyworks, or strip some balises.'],"apps"=>['the restriction 61 is activated : the default Apps are loaded, and the yours are added after (system/default_apps)'],"apps_add"=>['Apps presets. when rstr 61 is active, the user apps replace the system apps.
...
- #public : call the room \'public\' of the Chat'],"suggest"=>['You can import web content from the article url, a preview will try to display. Don\'t worry if the page doesn\'t display correctly.

The mail field allows you to add a mention \"Suggested by [mail prefix]\". You will be notified when the page is published.

Thank you for your contribution!'],"suggest_ok"=>['Your article have been published'],"console_cond"=>['The modules (the page elements) belong to a[context: b]. By default, they are:\"home\",\"cat\" (for a category of articles) and \"art\" (read an article). We can create personalized contexts, declined of cat and art.
...
- connectors : [param§option:connector]'],"artstats"=>['The stats for an article are visibles only after have been flushed (one time by day)'],"track_orth"=>['Please think to be understood, and breath three times before to write !'],"tracks_error1"=>['bad Captcha'],"tracks_error2"=>['please give your name'],"tracks_error3"=>['empty message'],"retape"=>['Some old connectors have been replaced'],"prmb5"=>['the param \'auto_design\' (5) is activated : it works instead of the user design'],"flog"=>['Remember your ID to retrieve yours datas'],"memstorage"=>['contents are stored in local vars of your own browser and are only visibles to you'],"blocmenu"=>['this div is linked to css to display correctly the ul<li'],"bloctest"=>['will not be rendered, it\'s used for testing modules'],"ftext"=>['content and edition are public'],"first_user"=>['Create Admin account'],"new_user"=>['Create account'],"meta_lang"=>['ID of articles in others languages'],"tracks_moderation"=>['tracks are moderated'],"twitter_oAuth"=>['parameters of twitter API (https://apps.twitter.com/)'],"tag_rename"=>['Rename a tag could delete and associate articles to an existing tag'],"usertags"=>['Add tags to this article and retrieve themes in your favorites. The user tags are publics.'],"api"=>['The API give datas from a query.
...
We can see that the overall structure (small - large - small) is maintained at all levels, and that this table can be extended indefinitely.'],"fav_fav"=>['Articles favorites'],"fav_tags"=>['Articles referenced by added Tags'],"fav_com"=>['Api\'s parameters for list of articles'],"fav_poll"=>['Voted Articles'],"fav_visit"=>['visited Articles'],"fav_shar"=>['Shared Articles'],"fav_edit"=>['Script of the Api'],"fav_like"=>['Liked Articles'],"levenshtein"=>['Algorithm of Levenshtein'],"study"=>['Allows you to create a text study, sentence by sentence.'],"tlex"=>['Publish on Tlex : add the oAuth of the Api in the table users/(hub)_tlex.
...
- exclude
- ignore (by default)
the terms of the request'],"star"=>['- ra (right ascension in hours), dc (declination in degrees), and dist (distance in AL)
...
HD 150680, hd150680, hip99461, 88601, 2021'],"gaia"=>['example 1, with dc (declination), ra (right ascent) and dist (degrees and AL): 
...
[1464§1:umcom:on] display the link'],"mercury"=>['Universal web player'],"mercurykey"=>['Admin: add the api_key (mercury.com) in the mercury table, row 1 column 0'],"not_published"=>['Article not published'],"tables"=>['Separators : 
- columns:\"|\" or [coma]
- lines: \"¬\"or [line break]'],"twits"=>['calls a series of twits designated by their numerical id and separated by a space'],"tweetfeed_help"=>['use only one or more \'api_arts\' module'],"purpose"=>['Add and vote on proposals; you can only delete your entry on the current day.'],"nodes"=>['This will create a new layer of hubs (a Node).
Change node : /?qd=nodename
Write $qd=\"pub2\"; in _connectx to assign a domaine name to the node \'pub2\'.'],"updatenotes"=>['release notes'],"lastupdate"=>['Last synchronization'],"softwareupdated"=>['The software has been updated'],"softwarever"=>['Actual version'],"softwaredist"=>['Distant version'],"updatedetails"=>['details of the last update'],"updateno"=>['This server is not set to receive updates'],"cookie"=>['The cookie named \"iq\" contains the id of your IP, which makes it possible to consider only one visitor even if your IP changes. See [privacy:help§data privacy policy].'],"privacy"=>['The site does not use or resell any data related to visitors, except for site traffic statistics.
All activities on the site are cancelled on average every year.'],"urmrsrch"=>['Search for :
- an id (1873)
- a title (Oay-126)
- a date ymd (150706)
- a term in any language
- a list of ids or titles (ot-100,1873,312-14) (also in spreadsheet mode)'],"starmap"=>['HD or HIP stars (HIP by default)
