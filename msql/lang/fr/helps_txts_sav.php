...
"designcond"=>['Le démarrage d\'une session d\'édition de design utilise des feuilles css créées spécialement (dev).
...
"comline"=>['Ligne de commande : Certains modules utilisent une commande de modules comme paramètre (MenusJ, Apps, le connecteur \':module\').'],
...
- date précise (API) : \"date:1967,\" ou \"date:-08-15\" (tous les 15 aoûts)'],
...
"console_mods"=>['Le [menu de mods:b] n\'affecte que la session en cours. Pour que les effets prennent effet pour le visiteur, il faut l\'appliquer, pour que le numéro de version de la table de module figure dans [config/param/modules_table:l].'],
"scripts"=>['param/titre/commande/option/en cache/masquer/template/br:module§button[,]'],
...
"api"=>['L\'API permet de réaliser des tris complexes via une commande.
...
Écrivez $qd=\"pub2\" ; dans _connectx pour attribuer un nom de domaine au n&oelig;ud \"pub2\".'],
