...
"9"=>['[day DESC][suj ASC]'],
"7"=>['[day DESC][suj ASC]'],
"11"=>['auth_level para nuevos usuarios (1-7) :ver master_config/create_hub privilege'],
"16"=>['article deadline in number of days
valor][auto = frecuencia: 50 arts/period]'],
"17"=>['[default ymd:Hi][d/m/Y H:i]'],
"18"=>['additional tag classes (separator : space)'],
"19"=>['usertags icons (respect position)'],
"21"=>['separator : space'],
"23"=>['upload'],
