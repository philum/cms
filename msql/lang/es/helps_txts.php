...
- API script, e. g.\"from: 2012-01-01, until: 2014-01-01\".'],"defcons"=>['The Definitions are using some input and outputs for title, text, and another option if needed. Il the output is not set, it will be the natural end of the balise. Lot of rules let adjust the content, as del the title, the line 1, a link or a line with a keyworks, or strip some balises.'],"apps"=>['the restriction 61 is activated : the default Apps are loaded, and the yours are added after (system/default_apps)'],"apps_add"=>['Apps presets. when rstr 61 is active, the user apps replace the system apps.
...
a list of stars named by their id Gaia (number of 19 digits) separated by a space.'],"umrec"=>['Para llamar a un mensaje específico: 
http://oumo.fr/context/compile/O6-144
Para integrarlo en una página web mediante un iframe (usar id) :
http://oumo.fr/plug/umrec/1464
Del editor (artículo o comentarios):
[1464:umcom:on]']];