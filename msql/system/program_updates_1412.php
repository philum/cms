<?
//philum_microsql_program_updates_1412
$r["_menus_"]=array('date','text');
$r[1]=array('1201','publication');
$r[2]=array('1203','révision rédaction composants msql');
$r[3]=array('1204','réfection de timetravel : (remarche), accessible depuis le menu admin');
$r[4]=array('1205','amélioration du gestionnaire utags : différenciation entre le terme présenté et le terme connu (pas de caractères spéciaux dans l\'url)');
$r[5]=array('1206','amélioration du système de titres (souvent affichés avant d\'être connus) le module page_titles est surtout interne aux actions');
$r[6]=array('1210','rénovation de artmod : templates, css, rstr');
$r[7]=array('1211','- abandon du module système popadmin (rendu interne avec tout un jeu de rstr)
- abandon de l\'éditeur de largeurs du design
- rénovation du desktop, qui se load avec une rstr');
$r[8]=array('1212','rénovation de artmod : templates, css, rstr');
$r[9]=array('1213','ajout d\'une classe mysql (très pratique) et rénovation de la classe msql');
$r[10]=array('1215','réfection du modèle de plugin et de la classe msq');
$r[11]=array('1216','- les subarticles trop nombreux sont mis en flow
- réfection du connecteur :pop : les données sont stockées plutôt qu\'envoyées
- nouveau menu msql
- échec de l\'implantion des classes msql');
$r[12]=array('1217','- les catégories préfixées d\'un underscore sont écartées du Load (sauf appel spécifique)
...
$r[13]=array('1218','- aménagement du système des titres
- ajout du plugin reader, pour offrir la home dans une iframe
- delfile sécurisé dans msql');
$r[14]=array('1219','- ajout (et réfection) des plugs arts, read, reader (lecture externe), imtx et imgtxt
...
$r[15]=array('1222','- petite révision des templates');
$r[16]=array('1223','- petite révision du moteur de recherche
- les tags ouvrent plutôt des popups
- renommages ');
$r[17]=array('1224','- réparation du title des tags
...
$r[18]=array('1225','- nombreux correctifs pour quand on n\'est pas logué...
