<?php //philum/microsql/default_htaccess_sav
$r=["_menus_"=>['title_1'],1=>['RewriteEngine on
...
RewriteRule ^rss/([^.]+)$ /call.php?plug=rss&p=$1 [L]
RewriteRule ^api/([^.]+)$ /call.php?plug=apicom&p=$1 [L]
RewriteRule ^call/([^.]+)/([^.]+)/(.+)$ /call.php?plug=$1&p=$2&o=$3 [L]
RewriteRule ^call/([^.]+)/([^.]+)$ /call.php?plug=$1&p=$2 [L]
RewriteRule ^call/([^.]+)$ /call.php?plug=$1 [L]
RewriteRule ^vacuum/(.+)$ /plug/vacuum.php?url=$1 [L]
RewriteRule ^vacuum/conn/(.+)$ /plug/vacuum.php?url=$1&mode)$2 [L]
...
RewriteRule ^context/([^/]+)/([^/]+)$ /?context=$1&opt=$2 [L]
