...
$r[24]=array('1224','- le menu msql de l\'admin renvoie les tables réelles de l\'utilisateur ;');
$r[25]=array('1225','- une série de fonctions sans usage a été désactivée temporairement (champs éditables)');
$r[26]=array('1226','- correctif erreur indicatif pour meta robots');
$r[27]=array('1227','- correctif compatibilité du template article avec le module d\'article \'open\' (ouvrir sur place) ;');
$r[28]=array('1228','- les menus select de l\'éditeur de meta sont remplacés par les composants ajax équivalents ;
...
$r[29]=array('1229','- réécriture du plugin de gestion des inscriptions à la newsletter (plugin \'mailist\'), en ajax ;');
$r[30]=array('1230','- fix décalage horaire dans le système d\'envoi de mails ;
- fix stupiderie dans l\'outil de tags ;');
$r[31]=array('1231','- rénovation du système d\'envoi de la newsletter (ajout d\'un plugin \'newsletter\') ;');
