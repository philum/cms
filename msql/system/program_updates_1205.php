...
$r[1]=array('0501','mise à jour de toutes les aides pour les 219 functions publiques du noyau (base program_core)');
$r[2]=array('0502','- introduction du paramètre \'auto_member\' : permet de déléguer des privilèges au visiteur (de 1 à 4) et faire de lui un membre automatiquement au moment où il poste un article ;
...
');
$r[3]=array('0505','- nouveaux boutons de la popup ;
...
$r[4]=array('0511','- correctif faille de sécurité engendré par le nouveau param \'auto_member\' ;
...
$r[5]=array('0512','perfectionnement de la fonction \'auto_member\' :
...
$r[6]=array('0513','- réparation du sélecteur d\'onglet (qui doit se souvenir de sa osition d\'une page à l\'autre) ;
...
$r[7]=array('0513','amélioration du fil rss :
...
$r[8]=array('0514','ajout des modules : 
...
$r[9]=array('0514','finalisation de la disposition automember :
...
$r[10]=array('0515','- ajout d\'une temporisation sur le détecteur d\'événements lors de la manipulation de champ d\'édition de l\'article, pour ne pas obtenir le bouton d\'enregistrement ajax alors que le nombre de caractères est trop élevé
- temporisation qui referme le menu admin rapide');
$r[11]=array('0515','- suppression d\'un trop ancien système de toggle au profit du nouveau, amélioré, (toggle) qui permet de choisir le mode, appartenant ou non à un groupe de boutons ;
- nouveaux boutons d\'édition d\'article ;
- dans la console les modules désactivés apparaissent en grisé ;');
$r[12]=array('0515','(jour des tralalas)
...
$r[13]=array('0516','- édition d\'articles dans l\'admin : le bouton \'save\' au-dessus de 5000 caractères ;
...
$r[14]=array('0517','réparation erreur des checkbox, qui pouvait provoquer l\'enregistrement systématique d\'un mauvais état du droit de publier des commentaires (l\'erreur semble dater de quelques jours) - donc maj immédiate');
$r[15]=array('0517','- réparation détecteur d\'activité du champ de recherche, pour émuler un \'onpaste\' tout en évitant les appels répétitifs ;
...
$r[16]=array('0518','- les \'autotags\' proposés (et présentés dans le module \'words\') sont classés par ordre de pertinence (d\'abord les plus nombreux, puis les ressemblances) ;
- réparation de l\'importateur de tables d\'autres serveurs dans  l\'admin msql ;');
$r[17]=array('0519','- ajout restriction 52 : afficher le batch_menu ;
...
$r[18]=array('0520','- les css sont présentés par catégories dans l\'édition du design ;');
$r[19]=array('0521','- réparation erreur utf8 des tickets ;
...
$r[22]=array('0524','- ajout d\'un composant \'copier-coller\' multiple et d\'un bouton \'supprimer\' (pour pas lâcher la souris !) ; la copie fonctionne beaucoup mieux que le bloc-notes en ajax, elle n\'est pas limitée en quantité, et les données sont stockées éternellement dans le navigateur.');
$r[23]=array('0525','- réparation erreur de fabrication de liens absolus des articles envoyés par mail ;
...
$r[24]=array('0526','- pas de correcteur orthographique dans les formulaires de l\'admin ;
...
');
$r[25]=array('0527','- ajout du composant \'copier-coller\' dans le bloc-notes ;
- nouvelle présentation des plugins, par catégories mixtes ;
');
$r[26]=array('0527','par convention les éléments \'h1\', \'h2\', \'h3\', \'h4\' doivent recevoir la valeur 0 pour l\'attribut margin : 
margin:0 0 0px 0;
...
$r[27]=array('0528','ajout d\'une fonction javascript \'connector\', réplique du noyau central :
...
$r[28]=array('0528','suppression de la restriction 48 \'icones_edition\', pas très signifiante ;');
$r[29]=array('0529','finalisation la capacité en javascript à situer les points d\'entrée et sortie des connecteurs imbriqués');
$r[30]=array('0530','- améliorations esthétiques : éditeur externe, boutons standards, iconographie ;
- améliorations pratiques : listes en ajax, édition en ajax dans l\'éditeur msql (jonction avec l\'admin) ; ');
$r[31]=array('0530','- finalisation de la jonction entre l\'admin msql et msql dans l\'admin : l\'édition peut se faire à la volée en ajax (ça marche !) ; 
