...
$r[1]=array('111110','ajout d\'un bouton qui permet de choisir la chronologie des articles affiliés à un article parent');
$r[2]=array('111118','amélioration du confort de la visionneuse flash \'Slider\'');
$r[3]=array('111119','correctifs détection de l\'ID des vidéos youtube et dailymotion');
$r[4]=array('111119','amélioration commodité de batch_import, permet d\'ajouter des url en série, avant de les importer en série');
$r[5]=array('111124','rénovation de \'model.php\', le modèle de plugins, pour une meilleure compréhension');
$r[6]=array('111124','ajout du plugin \'superpoll\' qui permet de voter des propositions :
...
');
$r[7]=array('111125','index.php peut désormais servir à appeler des plugins avec les variables ?call=plugin&param=&opt= (deux options), de façon à les rendre utilisable hors contexte, notamment lors d\'un appel depuis l\'extérieur dans une iframe');
$r[8]=array('111125','nouveau connecteur :video, qui remplace les connecteurs spécialisés de chaque provider (youtube, dailymotion, google, ted, livestream), étant donné que leur format est détectable');
$r[9]=array('111126','aménagements de fiabilité du nouveau connecteur :video ;
...
$r[10]=array('111130','introduction du module \'video_viewer\' qui recrute toutes les vidéos (avec le connecteur \':video\') des articles  publics (en cache) et les propose dans une fenêtre qui permet de naviguer de l\'une à l\'autre (viewer) ;
- le param permet d\'opérer un tri selon un ou plusieurs tags
');
$r[11]=array('111130','amélioration substantielle du moteur de recherche : 
...
$r[12]=array('111201','- ajout d\'un design par défaut nommé \'monoblog\' (colonne unique, simplicité, efficacité !) ;
