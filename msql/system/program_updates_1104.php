...
$r[1]=array('110401','mise en conformité avec les serveurs sous php4 (backslashes illégaux) ;');
$r[2]=array('110401','réforme de plug/rss1, [flux rss alternatif interrogeable par Flash:b]. Il est surtout \'interrogeable\' de sorte à produire des tris. Par défaut il se comporte comme \'rss\' en produisant une source issue du cache des articles, sans connexion à MySql. \'rss2\' disparaît.');
$r[3]=array('110402','renommage de \'radio\' en \'jukebox\' pour laisser la place à la future vraie \'radio\' (application Flash et nom du connecteur) ;');
...
$r[5]=array('110403','amélioration de l\'aide à l\'édition pour les url : affiche une popup en ajax à la place de la boîte de dialogue hideuse ;');
$r[6]=array('110403','amélioration de l\'aide à l\'édition de \'microsql\' qui propose désormais de choisir une table parmi celles existantes au lieu d\'avoir à aller chercher cette information dans l\'admin des microtables ;');
$r[7]=array('110405','petites améliorations de l\'éditeur de \'Slider\' : ajout de la fonction \'apply_to_all\' (laisser les champs inchangés vides, seuls les champs renseignés s\'appliquent à toutes les entrées, de sorte à ajouter une signature par exemple).');
$r[8]=array('110406','amélioration significative de \'publish_site\' (qui ne sert qu\'aux éditeurs de fourches évolutives du logiciel) : fait un deuxième passage en sens inverse (d\'abord les éléments publiés et ensuite les éléments à publier) de façon à effacer les obsolètes.');
$r[9]=array('110406','ajout d\'un onglet \'code\' dans l\'admin pour scruter le code source ;');
$r[10]=array('110407','réparation de \'vacuum\' de sorte qu\'il sache prendre en compte les sites Philum et importer les articles sans avoir spécifiquement informé les définitions ;');
$r[11]=array('110407','condamnation de la restriction \'explicit_url\' en raison de certaines lacunes qui doivent être révisées ;');
$r[12]=array('110408','ajout d\'un bouton permettant de retrouver les \'restrictions\' par défaut ;');
$r[13]=array('110408','mise à jour de certaines aides en ligne des restrictions ;');
$r[14]=array('110409','raccordement des paramètres et restrictions par défaut aux microbases \'system/default\' (au lieu des antiques paramètres écris à la main) ;');
$r[15]=array('110409','amélioration du sélecteur de restrictions qui ne fait qu\'un seul appel à la microbase de référence des noms au lieu de deux ;');
$r[16]=array('110409','amélioration du détecteur \'kmax\' quand l\'article est un connecteur d\'importation d\'un autre hub : suppression de toute la spécification puisque le connecteur lui-même se charge de savoir si l\'article doit être présenté en monde \'preview\' ou pas (gain de vitesse) ;');
$r[17]=array('110409','ajout d\'un coussin pour appeler les modules par défaut si jamais ils ont été détruits par une opération malheureuse (ce qui produisait l\'affichage de RIEN) ;');
$r[18]=array('110410','correctif de sécurité à propos de la casse des log-in (empêcher une casse alternative de se loguer) ;');
$r[19]=array('110410','correctif du destructeur de hubs : accessible au niveau 6, avec une étape de confirmation ;');
$r[20]=array('110411','rénovation du système de [pétition:b] :
...
$r[21]=array('110412','[protocole des plug-ins:b] : chaque plug-in appelle une fonction du nom de la page ;');
$r[22]=array('110412','mise à jour du modèle de plug-ins, y ajoutant le moyen de faire du ajax facilement ;');
$r[23]=array('110413','mise en conformité du flux Rss avec W3c ;');
$r[24]=array('110414','réparation (petite) faille de sécurité au moment de la connexion ;');
$r[25]=array('110414','rénovation du système de notes de bas de page : amélioration substantielle de l\'ergonomie. Selon qu\'on rédige du texte (curseur placé) ou qu\'on l\'édite (double-clic) les options sont différentes. Une popup en ajax remplace l\'alerte windows. La fenêtre demande se fixer le point d\'ancrage du lien sélectionné ou propose d\'en fixer d\'autres.');
$r[26]=array('110415','révision de l\'emploi des liens javascripts : abolition de \'javascript:...\' au profit d\'un plus moderne \'onClick:\' ; (les premiers étant rendus non fonctionnels par Firefox 4).');
$r[27]=array('110416','réforme dans le module \'channel\' : spécification d\'un nouveau paramètre \'site\' afin de régler un conflit permettant à ce module d\'être lancé au sein d\'un connecteur \'ajax\' ; (en clair, le connecteur ajax renvoie des modules, et parmi eux on peut désormais inclure \'channel\' - pour faire cela il a suffit de supprimer 3 lignes de code et de réformer la procédure, au lieu de rajouter du code)');
$r[28]=array('110416','amélioration du module \'msql_links\' de sorte à remplacer les modules \'rss_urls\' et \'links\' [rendus obsolètes:c] :
...
$r[29]=array('110417','deuxième amélioration du système de [notes de bas de pages:b] (ancres) :
...
$r[30]=array('110418','amélioration substantielle les [filtres de texte:b] (les cases à cocher de l\'éditeur disparaissent au profit d\'un nouvel onglet d\'aide à l\'édition nommé \'filters\' et qui propose de les faire fonctionner en ajax. Ainsi le résultat, s\'il n\'est pas celui désiré, au moins s\'affiche immédiatement avant la prochaine sauvegarde, sans risquer d\'abimer son contenu.');
$r[31]=array('110418','ajout (mais désactivation) d\'un système pour revenir à la précédente version d\'un enregistrement (inutile dans la pratique) ;');
$r[32]=array('110419','augmentation de la précision du [connecteur \':ajax\':b] et du [module \'MenusJ\':b] qui fonctionnent avec les mêmes algorithmes. (prise en compte du titre du module et de la cible de l\'appel). Cela permet de créer des menus en ajax qui affichent le résultat d\'un module (avec param, titre, commande, option) dans une cible (target) en affichant un titre (button).
...
$r[33]=array('110419','mise à jour en conséquence des microbases système.');
$r[34]=array('110420','[support des sous-domaines ::b]
...
$r[40]=array('110425','petit correctif de sauts de lignes d\'origine inconnue qui forçait à interpréter une entrée qui n\'avait pas besoin de l\'être (petite bêtise qui était là depuis sûrement longtemps !)');
$r[41]=array('110425','création du [module \'rssj\':b] qui renvoie la liste des flux rss de sorte qu\'on puisse consulter le contenu de chacun d\'eux sur place en ajax ;
...
$r[42]=array('110425','réforme du système des numéro de version : - création d\'une table \'system/program_version\' à laquelle se réfèrent \'plug/distribution\' et \'sys.php\', et que met à jour automatiquement \'plug/publish_site\'.');
$r[43]=array('110425','réforme du système de mises à jour : création de la table \'system/program_updates_x\' (une table chaque mois) qui [recense toutes les modifications de façon à ce qu\'elles soient relatées:b] dans admin/update au moment de la mise à jour');
$r[44]=array('110426','compatibilité des ancres importées depuis un autre site Philum');
$r[45]=array('110427','le module rssj qui est apparu, rss ayant disparu, le module rssj est renommé \'rss\' (que de chemin parcouru !)');
$r[46]=array('110427','intégration du concept de \'[template ponctuel:b]\'. Les modules reçoivent une colonne d\'information \'template\' et le module \'articles\', avec l\'option \'multi\', est capable de traiter les articles issus du tri avec un template désigné ponctuellement. Le template ponctuel est le troisième niveau de templates, après le local et le global.');
$r[47]=array('110427','réforme de la nomination des tables de modules. Un paramètre dans admin/config/params spécifie le numéro de la table (1 par défaut).
...
$r[48]=array('110427','ajout du patch pour informer les modules du nouveau nombre de colonnes, et pour les déplacer vers le nouveau format nominatif');
$r[49]=array('110428','petite réforme de l\'appel ajax pour les plug-ins :
...
$r[50]=array('110428','amélioratons du plug-in \'sliders\' :
- mise en conformité avec call_plug_func ;
- réparation du \'rebuild\' ;
- ajout d\'un bouton \'delete\' ;');
$r[51]=array('110429','cohérence entre les connecteurs, modules et codeline \'url\' et \'link\' :
...
$r[52]=array('110429','ajout du module \'codeline\' qui permet d\'accéder à la librairie de construction de balises html imbriquées');
$r[53]=array('110429','réforme du Footer, désormais branché sur le tronc principal des modules, est capable de profiter de sa technologie (mise en cache, accès à tous les modules existants, prise en compte des options avancées) ;
DONC (désolés !) il faut ajouter l\'option \'nobr\' sur chaque module du Footer pour retrouver la pagination initiale.');
$r[54]=array('110429','ajout d\'une capsule qui crée une table à partir de l\'ancienne au moment où on change le paramètre des modules de la config');
$r[55]=array('110430','extension du domaine d\'inférence des templates ponctuels à tous les tris issus du module \'articles\'');
$r[56]=array('110430','introduction du concept de miniatures à dimensions choisies par l\'utilisateur :
...
$r[57]=array('10430','déplacement de la table des connecteurs de codeline avec les autres connecteurs');
