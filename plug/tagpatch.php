...
msquery('ALTER TABLE '.ses('qdd').' DROP day, DROP cat;'); $ret.='datas deleted';
msquery('UPDATE '.ses('qda').' SET thm=""'); $ret.='old tags deleted';
return $ret;}
...
//patch tags
function plug_tagpatch($p,$o){$rid='plg'.randid();
