...
$r["html5"]=array("border-radius:7px;","box-shadow:0px 0px 8px -4px #_4;","text-shadow:1px 1px 2px #_4;","background:linear-gradient(to bottom,#_2,#_1) no-repeat fixed;","-moz-box-sizing:border-box;","transition: all 0.2s ease;","color:rgba(0,0,0,0.5);","rgba(255,255,255,0.5)","left:calc(50% + 10px);","-moz-column-count:2; -moz-column-gap:20px;");
