...
function sliderJ_img($f,$n){$w=cw(); 
list($n,$na)=explode('-',$n); $sdj='sdjp'.$na;
...
function sliderJ_thumbs($r,$f,$a){$w=cw(); if($r)unset($r['_menus_']);
...
function plug_sliderJ($f,$id,$o){$w=cw(); static $i; $i++; 
