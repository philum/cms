...
$rf=array("index.php","ajax.php","plug.php","install.php","htaccess.txt","favicon.ico","readme.txt","vps.txt",'params/_connectx.php.txt',
"avatar/FungShui","css","msql","params","plug","prog","progb","pub","video",
