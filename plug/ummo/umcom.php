...
return balb('blockquote',divd('umrec'.$p,$ret));}//$bt.
...
//ummo_aliens_4
if(strpos($p,'_')){$ret=''; $r=msql::col('',$p,0); foreach($r as $k=>$v)if($v)$ret.=self::home($v,$o); return $ret;}
if(strpos($p,',')){$ret=''; $r=explode(',',$p); foreach($r as $k=>$v)$ret.=self::home($v,$o); return $ret;}
