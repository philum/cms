...
$w=self::$w; $h=$w/2; $mw=$w/24; $mh=$h/12; $sz=6; //pr($r);
list($white,$black,$red,$green,$blue,$yellow,$cyan,$silver,$gray,$orange,$c2,$c3,$c4,$c5,$c6)=$klr;
//list($amical,$inamical,$neutre,$galaxy,$hostile)=self::clr($im);
...
$j=$rid.'_app__2_starmap3_call___inp';
