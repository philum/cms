...
CMS
System to create websites/blogs
...
- set designs with css builder, use face-fonts, set colors schemes
- set config and restrictions (easy access to config)
- set params of server
- create alternatives templates to the defaults
- manage/share files in user disk
- manage front admin menus
- manage your users/editors
...
- tags are editables and can call some modules/plugins
- a motor of templates can be used
- user can create some connectors

Everything is in ajax :
- work on place to edit or add articles
- easy to configure

The coding is extremely codyfied, to be the lightest as possible.
Philum assume to be the fastest CMS actually (comparing to it's complexity), 
and work easily on low-cost servers.

The users can :
- get updates everythime
- make forks and become producer
- develop code (and design) on place in dev mode, without affect the work in prod
